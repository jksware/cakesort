#include "CakeSortCoOp.cuh"

__global__ void BBox::CUDA::binSearchTidGroupKernelCoOp(const int *start, int *subset, const int length,
...
__global__ void BBox::CUDA::setGidKernelCoOp(int* data)
{
